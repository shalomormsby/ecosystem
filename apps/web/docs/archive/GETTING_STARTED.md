# Getting Started with Sage Studio
...
Sage Studio is an **interactive documentation website** for the Sage UI. It's a Next.js app that imports components from `@ecosystem/design-system` and provides:
...
**Strategic context:**
- [Sage Studio Strategy](../../design-system/docs/SAGE-DESIGN-STUDIO.md) - Vision and roadmap for the Studio
