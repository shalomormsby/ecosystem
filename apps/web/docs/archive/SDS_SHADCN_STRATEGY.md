...
**Legend:**
*   ✅ **@thesage/ui**: Implemented in the modern, Radix-based package.
*   ⚠️ **Legacy**: Exists in `@ecosystem/design-system` but needs migration to `@thesage/ui`.
*   ❌ **Missing**: Not yet present in SDS.

| Component | Sage UI Status | Shadcn | Priority | Notes |
| :--- | :--- | :--- | :--- | :--- |
| **Accordion** | ✅ @thesage/ui | Available | Medium | **Verified Fix**: Animation smoothed. Essential for FAQs. |
| **Alert** | ✅ @thesage/ui | Available | **Critical** | Essential for feedback messages. |
| **Alert Dialog** | ✅ @thesage/ui | Available | Medium | |
| **Aspect Ratio** | ✅ @thesage/ui | Available | Low | Migrated from AspectImage. |
| **Avatar** | ✅ @thesage/ui | Available | High | Replaces legacy Avatar. |
| **Badge** | ✅ @thesage/ui | Available | Done | |
| **Breadcrumb** | ✅ @thesage/ui | Available | Medium | Replaces legacy Breadcrumb. |
| **Button** | ✅ @thesage/ui | Available | Done | |
| **Calendar** | ✅ @thesage/ui | Available | Low | Complex, add when needed. |
| **Card** | ✅ @thesage/ui | Available | Done | |
| **Carousel** | ✅ @thesage/ui | Available | Low | |
| **Checkbox** | ✅ @thesage/ui | Available | Done | |
| **Collapsible** | ✅ @thesage/ui | Available | Medium | |
| **Combobox** | ✅ @thesage/ui | Available | High | Often requested for forms. |
| **Command** | ✅ @thesage/ui | Available | High | Basis for command palettes. |
| **ContextMenu** | ✅ @thesage/ui | Available | Low | |
| **Data Table** | ✅ @thesage/ui | Available | **Critical** | Essential for dashboards and data display. |
| **Date Picker** | ✅ @thesage/ui | Available | Medium | |
| **Dialog (Modal)** | ✅ @thesage/ui | Available | **Critical** | Replaces legacy Modal. Major UI building block. |
| **Drawer** | ✅ @thesage/ui | Available | Medium | Good for mobile. |
| **Dropdown Menu** | ✅ @thesage/ui | Available | **Critical** | Replaces legacy Dropdown. Essential for actions. |
| **Form** | ✅ @thesage/ui | Available | **Critical** | Replaces legacy Form. `react-hook-form` + `zod` integration. |
| **Hover Card** | ✅ @thesage/ui | Available | Low | |
| **Input** | ✅ @thesage/ui | Available | Done | |
| **Input OTP** | ✅ @thesage/ui | Available | Low | |
| **Label** | ✅ @thesage/ui | Available | Done | |
| **Menubar** | ✅ @thesage/ui | Available | Low | Desktop app feel. |
| **Navigation Menu** | ✅ @thesage/ui | Available | Medium | For complex headers. |
| **Pagination** | ✅ @thesage/ui | Available | Medium | |
| **Popover** | ✅ @thesage/ui | Available | High | **Verified Fix**: Token background issues resolved. |
| **Progress** | ✅ @thesage/ui | Available | Medium | Replaces legacy ProgressBar. |
| **Radio Group** | ✅ @thesage/ui | Available | **Critical** | Basic form element. |
| **Resizable** | ✅ @thesage/ui | Available | Low | **Verified**: Renders correctly (fixed import group issues). |
| **Scroll Area** | ✅ @thesage/ui | Available | Done | |
| **Select** | ✅ @thesage/ui | Available | Done | |
| **Separator** | ✅ @thesage/ui | Available | Done | |
| **Sheet** | ✅ @thesage/ui | Available | **Critical** | Sidebars, panels. |
| **Skeleton** | ✅ @thesage/ui | Available | Done | |
| **Slider** | ✅ @thesage/ui | Available | Medium | |
| **Sonner (Toast)** | ✅ @thesage/ui | Available | High | A better toast experience. |
| **Switch** | ✅ @thesage/ui | Available | Done | |
| **Table** | ✅ @thesage/ui | Available | **Critical** | Basic data presentation. |
| **Tabs** | ✅ @thesage/ui | Available | High | Content organization. |
| **Textarea** | ✅ @thesage/ui | Available | High | Form element. |
| **Toast** | ✅ @thesage/ui | Available | Done | |
| **Toggle** | ✅ @thesage/ui | Available | Low | |
| **Toggle Group** | ✅ @thesage/ui | Available | Low | |
| **Tooltip** | ✅ @thesage/ui | Available | Medium | Replaces legacy Tooltip. |
...
4.  **Documentation**:
    *   Add component to `apps/web/.../component-registry.tsx`
...
5.  **Update Consumers**: Migrate all internal usage to `@thesage/ui` imports
...
- Dialog (Modal) → `@thesage/ui/dialog`
- Dropdown Menu → `@thesage/ui/dropdown-menu`
- Form → `@thesage/ui/form`
- Avatar → `@thesage/ui/avatar`
- Breadcrumb → `@thesage/ui/breadcrumb`
- Progress → `@thesage/ui/progress`
- Tooltip → `@thesage/ui/tooltip`
- Aspect Ratio (AspectImage) → `@thesage/ui/aspect-ratio`
...
*Location: `@thesage/ui` (and Shadcn parity)*
...
- Update all internal apps to use `@thesage/ui` imports
...
- Update all documentation to reference only `@thesage/ui`
...
**Adoption Metrics:**
- Monitor usage of `@thesage/ui` vs legacy components across all apps
...
- ✅ Added to component registry at `apps/web/app/components/lib/component-registry.tsx`
...
- ✅ All components exported from `@thesage/ui`
...
**Actions Taken:**
- ✅ Installed \`@radix-ui/react-avatar\` in \`@thesage/ui\`
...
- ✅ Updated \`component-registry.tsx\`:
    ...
    - Added New \`Avatar\` configuration using \`@thesage/ui\` imports
...
**Build Verification**:
- ✅ @thesage/ui package: 67.39 KB (CJS), 56.69 KB (ESM)
...
- ✅ **43 total components** in @thesage/ui (22 from Phases 1-2 + 21 from Phase 3)
...
**Build Metrics:**
- ✅ @thesage/ui package: 121.18 KB (CJS), 102.72 KB (ESM)
...
- **Fix**: Populated `apps/web/app/globals.css` with the complete set of CSS variables (`--color-background`, `--color-popover`, etc.) mapped to Sage UI tokens.
