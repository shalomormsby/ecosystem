...
- Updated `/apps/web/app/components/lib/component-registry.tsx` with component configs
...
1. **Start dev server** if not running: `cd apps/web && pnpm dev`
