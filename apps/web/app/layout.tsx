...
const PRODUCT_DESCRIPTION = '92 accessible React components, three themes, user-controlled motion. Built on Radix UI + Tailwind CSS with TypeScript strict mode.';
