...
- Location: `apps/sage-design-studio/app/components/studio/OverviewSection.tsx`
- URL: https://ui.shalomormsby.com/docs#overview
- Contains: Installation, Quick Start, Basic Usage, ThemeProvider setup

**MCP Server Pages:**
- Location: `apps/sage-design-studio/app/components/studio/McpSection/`
...
- `apps/sage-design-studio/app/components/studio/OverviewSection.tsx`
- `apps/sage-design-studio/app/components/studio/McpSection/InstallationTab.tsx`
...
**Files to Update:**
- `apps/sage-design-studio/app/components/studio/OverviewSection.tsx`
- `apps/sage-design-studio/app/components/studio/McpSection/OverviewTab.tsx`
...
**Files to Update:**
- `apps/sage-design-studio/app/components/studio/OverviewSection.tsx` (lines 875-900)
...
**Original Problem:**
Config showed `npx @sage/mcp` which didn't exist on npm (404).
...
- `apps/sage-design-studio/app/components/studio/OverviewSection.tsx` - Installation commands
- `apps/sage-design-studio/app/components/studio/McpSection/InstallationTab.tsx` - MCP installation
- `packages/sds-mcp-server/README.md` - Package references
- `apps/sage-design-studio/docs/AUDIT-PROGRESS.md` - Progress tracker
- `apps/sage-design-studio/docs/SAGE-UI-AUDIT-CONSOLIDATED.md` - This file (NEW)

### To Be Updated (Phase 0 Remaining)
- `apps/sage-design-studio/app/components/studio/OverviewSection.tsx` - Prerequisites, component counts
- `apps/sage-design-studio/app/components/studio/McpSection/OverviewTab.tsx` - Component counts
