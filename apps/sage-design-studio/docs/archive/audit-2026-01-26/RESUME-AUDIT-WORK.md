...
**Audit Location:** `apps/sage-design-studio/docs/SAGE-UI-AUDIT.md`
...
**Key Files to Update:**
- Getting Started: `apps/sage-design-studio/app/components/studio/OverviewSection.tsx`
- MCP Section: `apps/sage-design-studio/app/components/studio/McpSection/*.tsx`
